        ...
        (info) => {
            ...
            flatObjects.forEach((obj) => {
                ...
                cornersLocal.forEach(p => {
                    ...
                    const relP = pWorld.sub(planePointA); // Use planePointA as reference for 2D projection on A? 
                    // Wait, originally it projected relative to planePointA?
                    // Line 462: const relP = pWorld.sub(planePointA);
                    // Yes.
